                        ...
                        <ul className="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <Link to="/#" className="has-arrow waves-effect">
                                    ...
                                    <span className="ml-1">{this.props.t('Collaborators')}</span>
                                </Link>
                                <ul className="sub-menu" aria-expanded="false">
                                    <li><Link to="Collaborators-new-template">{this.props.t('New Template')}</Link></li>
                                    <li><Link to="Collaborators-collaborative-visits">{this.props.t('Collaborative Visits')}</Link></li>
                                    <li><Link to="Collaborators-collaborative-conferences">{this.props.t('Collaborative Conferences')}</Link></li>
                                    <li><Link to="Collaborators-collaborative-publications">{this.props.t('Collaborative Publications')}</Link></li>
                                </ul>
                            ...
                            <li>
                                <Link to="/#" className="has-arrow waves-effect">
                                    ...
                                    <span className="ml-1">{this.props.t('Faculty')}</span>
                                </Link>
                                <ul className="sub-menu" aria-expanded="false">
                                    <li><Link to="Faculty-Incoming-faculty">{this.props.t('Incoming Faculty')}</Link></li>
                                    <li><Link to="Faculty-Outgoing-faculty">{this.props.t('Outgoing Faculty')}</Link></li>
                                </ul>
                            </li>
                        
                
                            <li>
                                <Link to="International-webinars" className=" waves-effect">
                                    <i className="ri-webcam-line"></i>
                                    <span className="ml-1">{this.props.t('International Webinars')}</span>
                                </Link>
                            </li>
                            <li>
                                <Link to="/#" className="has-arrow waves-effect">
                                    <i className="ri-leaf-line"></i>
                                    <span className="ml-1">{this.props.t('Centre for Social Action (CSA)')}</span>
                                </Link>
                                <ul className="sub-menu" aria-expanded="false">
                                    <li><Link to="CSA-Incoming-students">{this.props.t('Incoming Students')}</Link></li>
                                    <li><Link to="CSA-Incoming-faculty">{this.props.t('Incoming Faculty')}</Link></li>
                                </ul>
                            </li>
                            <li>
                                <Link to="Curriculum-Internationalization" className=" waves-effect">
                                    <i className="ri-book-open-line"></i>
                                    <span className="ml-1">{this.props.t('Curriculum Internationalization')}</span>
                                </Link>
                            </li>
                            <li>
                                <Link to="/#" className="has-arrow waves-effect">
                                    <i className="ri-survey-line"></i>
                                    <span className="ml-1">{this.props.t('Research Projects')}</span>
                                </Link>
                                <ul className="sub-menu" aria-expanded="false">
                                    <li><Link to="Research-Funded-Research">{this.props.t('Funded')}</Link></li>
                                    <li><Link to="Research-Non-Funded-Research">{this.props.t('Non Funded')}</Link></li>
                                </ul>
                            </li>
                            <li>
                                <Link to="Contact-Details" className=" waves-effect">
                                    <i className="ri-contacts-book-line"></i>
                                    <span className="ml-1">{this.props.t('Contact Details')}</span>
                                </Link>
                            </li>
                            <li>
